...
public class SeccionEActivity extends FragmentActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        if (encuesta != null) {
        	...
        	if(tieneValor(encuesta.getEalimund())){  modifPage = (SingleFixedChoicePage) mWizardModel.findByKey(labels.getEalimund());datoCatalogo = sivinAdapter.getMessageResource(MainDBConstants.catKey + "='" + encuesta.getEalimund() + "' and " + MainDBConstants.catRoot + "='CAT_LACTTIEMP'", null);  dato = new Bundle(); if(datoCatalogo!=null) dato.putString(SIMPLE_DATA_KEY, datoCatalogo.getSpanish()); modifPage.resetData(dato); modifPage.setmVisible(true);}
    ...
    public void saveData(){
        try {
    		...
    		if (tieneValor(ealimund)) { 
    			catRespuesta = sivinAdapter.getMessageResource(MainDBConstants.spanish + "='" + ealimund + "' and " + MainDBConstants.catRoot + "='CAT_LACTTIEMP'", null); if (catRespuesta!=null) encuesta.setEalimund(catRespuesta.getCatKey()); } else { encuesta.setEalimund(null);}
